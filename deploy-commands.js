...
const commands = [
  ...
  new SlashCommandBuilder()require('dotenv').config();
const { REST, Routes, SlashCommandBuilder } = require('discord.js');
...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption(opt =>
      opt.setName('name')
        .setDescription('Point type name')
        .setRequired(true)
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption(opt =>
      opt.setName('name')
        .setDescription('Rating system name')
        .setRequired(true)
    )
    .addStringOption(opt =>
  ...
  new SlashCommandBuilder()
    .setName('configure-point-access')
    .setDescription('Set which roles can manage each point type')
]
.map(cmd => cmd.toJSON());
